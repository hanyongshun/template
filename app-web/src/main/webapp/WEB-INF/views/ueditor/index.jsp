...
<head>
	...
	<script type="text/javascript" charset="utf-8" src="${contextPath}/resources/common/ueditor/ueditor.config.js"></script>
	<script type="text/javascript" charset="utf-8" src="${contextPath}/resources/common/ueditor/ueditor.all.js"> </script>
	<script type="text/javascript" charset="utf-8" src="${contextPath}/resources/common/ueditor/lang/zh-cn/zh-cn.js"></script>
	<title>Ueditor</title>
</head>
<body>
	<!-- 加载编辑器的容器 -->
    ...
    <script type="text/javascript">
		var ue = UE.getEditor('editor',
				{
					serverUrl:contextPath + "/ueditor/ueditor",
